          ...
          <div class="card-body p-6 md:p-10">
            <div class="flex items-start gap-6">
              ...
              <div class="flex-1 space-y-4">
                ...
                <div 
                    class="prose prose-lg max-w-none prose-headings:text-base-content prose-p:text-base-content/90 prose-strong:text-primary"
                    v-html="parsedAnswer"
                />
              </div>
            </div>
...
const parsedAnswer = computed(() => {
    ...
    // Parse markdown (async allowed but marked is sync by default unless async option used)
    const parsed = marked.parse(textWithCursor)
    return parsed
})
