<template>
  <div class="dropdown dropdown-end">
    ...
    <div
      class="dropdown-content z-50 h-[28.6rem] max-h-[260px] w-56 overflow-y-auto rounded-box border border-white/5 bg-base-200 text-base-content shadow-2xl outline outline-1 outline-black/5 md:max-h-[calc(100vh-10rem)]"
    >
